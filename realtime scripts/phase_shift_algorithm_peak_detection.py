...
threshold = 0.001       # threshold value for detecting peak values, set between 0 and 1
heatmap_empty = np.zeros((config.MAX_RES_X,config.MAX_RES_Y))
...
def main(signal):
    ...
    heatmap = (heatmap/(np.max(heatmap)+0.00001))**3
